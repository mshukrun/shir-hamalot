  ...
  return (
    <BrahotBox dir="RTL">
      ...
      <TableDiv>
        ...
        <RowDiv>
          <Cell3Div>{l10n.barchot.perot}</Cell3Div>
          <Cell2Div>{l10n.barchot.adama}</Cell2Div>
          <CellDiv>
            <div>{l10n.barchot.nefashot}</div>
            <div>{l10n.barchot.kashihor}</div>
          </CellDiv>
        </RowDiv>
        <RowDiv>
          <Cell3Div>{l10n.barchot.pishtan}</Cell3Div>
        ...
        <RowDiv>
          <Cell3Div>{l10n.barchot.tiras}</Cell3Div>
          <Cell2Div>{l10n.barchot.questionMark}</Cell2Div>
          <CellDiv>{l10n.barchot.nefashot}</CellDiv>
        </RowDiv>
        <RowDiv>
          <Cell3Div>{l10n.barchot.devash}</Cell3Div>
          <Cell2Div>{l10n.barchot.questionMark}</Cell2Div>
          <CellDiv>
            <div>{l10n.barchot.reviit}</div>
            <div>{l10n.barchot.noMatzoy}</div>
          </CellDiv>
        </RowDiv>
        <RowDiv>
          <Cell3Div>{l10n.barchot.temarim}</Cell3Div>
          <Cell2Div>{l10n.barchot.shehachol}</Cell2Div>
